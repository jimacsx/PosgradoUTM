	...
	<body>
		<div class="col-sm-9 col-md-10 col-sm-offset-3 col-md-offset-2 main">
			...
			<div id="edit-publicaciones" class="content scaffold-edit" role="main">
				...
				<g:form url="[resource:publicacionesInstance, action:'update']" method="PUT" >
					<g:hiddenField name="version" value="${publicacionesInstance?.version}" />
				<fieldset class="form-horizontal">
						<g:render template="form"/>
					</fieldset>
					<fieldset class="buttons col-sm-offset-2">
						<g:actionSubmit  class="btn btn-primary"  class="save" action="update" value="${message(code: 'default.button.update.label', default: 'Update')}" />
					</fieldset>
				</g:form>
			</div>
		</div>
